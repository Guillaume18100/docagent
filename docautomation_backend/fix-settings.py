...
def fix_django_settings():
    ...
    print("Searching for settings.py file...")
    settings_file = None
    
    # Common locations to check
    potential_paths = [
        'docautomation_backend/settings.py',
        'settings.py'
    ]
    ...
    if not settings_file:
        print("Searching directories recursively...")
    ...
    if not settings_file:
        print("ERROR: Could not find settings.py anywhere in the project")
        return False
